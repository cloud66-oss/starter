...
const ( // Luca: Add here the base repository path for the stencils template
	...
	baseStencilTemplatePath = "https://raw.githubusercontent.com/cloud66/stencils/{{.branch}}/" // this way we only have to add the filename. We should start by download the templates.json, do a couples of checks and after that download the stuff
...
func init() {
	...
	flag.BoolVar(&flagBundle, "bundle", false, "create and output the bundle file")
